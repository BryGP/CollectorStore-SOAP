...
@Configuration
@EnableWs
public class ProductoWebService extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema productosSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://com.Producto");
    ...
    public XsdSchema productosSchema() {
        return new SimpleXsdSchema(new ClassPathResource("EstructuraProducto.xsd"));
